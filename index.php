...
<html lang="en">
  ...
  <?php include 'connection.php'; ?>
    ...
    <div class="jumbotron text-center row" id="shadow">
        <div class="col-3">
            <a href="index.php"><img src="images/scp_logo2.jpg" class="img-fluid rounded mx-auto d-block img-responsive" height=140 width=140></img></a>
        </div>
        <div class="col-9">
    ...
    <div class="row" id="shadow">
        <div class="col nav-item active">
            <b><a href="add.php" style="color: white"> <button class="btn btn-primary button"> Insert New Data </button> </a></b>
            &emsp;
            <br>
            <br>
                ...
                if(isset($_GET['subject'])){
                    ...
                    <div>
                        <div>
                            ...
                            <p class='text-center'><b><h3>Welcome Agent, use the links above to view subject files or enter new subject data</h3></b></p>
